...
import de.scriptsdk.api.model.gump.components.LimitedTextEntryResponse;
...
@AllArgsConstructor
@NoArgsConstructor
public class LimitedTextEntryDto {
    ...
    public LimitedTextEntryDto(LimitedTextEntryResponse response) {
